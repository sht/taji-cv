...
But pandoc uses the default PDF template and you may not like it. To make simple and pleasing PDF, we will first have to convert `cv.md` to `cv.html`. To do that: 
...
- Open this html file offline in any browser and `Ctrl+P` to pop up print page window. 
    - Uncheck 'Header and Footer' option and save the file as PDF
